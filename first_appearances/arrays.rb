#create range between
x = 1..100
puts x.class

# use these in irb to check
# gives array and then shuffled array
x.to_a
x.to_a.shuffle
...
#converts to array of strings seperated by space
d = %w(hi there, my name is theo)
puts d[1]
...
e.select {|number| puts "#{number} -- #{number.odd?}"}
